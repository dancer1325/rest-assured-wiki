...
* `io.restassured.RestAssured.responseContentType(java.lang.String)` (`io.restassured.builder.ResponseSpecBuilder.expectContentType(io.restassured.http.ContentType)`  and apply it to `io.restassured.RestAssured.responseSpecification`)
