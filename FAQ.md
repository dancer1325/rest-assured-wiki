...
## 1. Q: I'm running into exceptions like the one below after having upgraded to REST Assured 1.8+
 ...
 ```
	...
	```groovy
	testCompile (group: 'io.rest-assured', name: 'rest-assured', version:'5.5.0') {
...
## 3. Issues with REST Assured and Grape
 ...
 > If you run into issues with Grapes such as:
  ...
  ```
  General error during conversion: Conflicting module versions. Module [groovy-xml is loaded in version 2.4.6 and you are trying to load version 2.4.4". This happens when running rest-assured 5.5.0 in a groovy script with any recent version of groovy except 2.4.4.
  ```
