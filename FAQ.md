...
## 3. Issues with REST Assured and Grape
 ...
 > If you run into issues with Grapes such as:
  ...
  ```
  General error during conversion: Conflicting module versions. Module [groovy-xml is loaded in version 2.4.6 and you are trying to load version 2.4.4". This happens when running rest-assured 4.2.0 in a groovy script with any recent version of groovy except 2.4.4.
  ```
